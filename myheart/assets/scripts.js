...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages: ["Chúc bạn Trung thu nhiều niềm vui và tiếng cười nha", "Ngày càng xinh gái, học giỏi", "Chúc gia đình bạn đoàn viên, vui vẻ!", "Đạt ước mơ mình mong muốn", "Đỗ nv1 nhoa nhoa"],
      images: [],
      heartColor: "#ff9090",
    },
  };
